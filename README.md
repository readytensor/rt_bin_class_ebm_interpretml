# Explainable Boosting Machine (EBM) Classifier in Python using the `InterpretML` library. with Shapley Explanations
## Project Description
...
- A **Explainable Boosting Machine (EBM) Classifier** algorithm built using **InterpretML** library.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Explainable Boosting Machine (EBM) classifier model implemented using **InterpretML** library.
